...
namespace Pong
{
    public class Ball : Shape
    {
        ...
        public Vector3 ballContactLocation { get; set; }
        public bool playerHit { get; set; }
        public bool opponentHit { get; set; }
        float speed;
        float radius;
        public Ball(GraphicsDeviceManager graphics, Model model, Vector3 position, Color color, float scale, Vector3 velocity, Effect effect) 
